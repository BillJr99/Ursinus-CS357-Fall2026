...
> *Hint:* Think about the bypass clause.  If you wrote "this check cannot be bypassed," you assumed that accidental deletion is a bigger risk than a case where bypassing is actually needed.  If you left a bypass path, you assumed the opposite.  Neither is wrong, but the choice reflects a value.
