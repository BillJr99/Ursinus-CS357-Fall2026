...
Work in your POGIL team with your rotated roles (**Manager**, **Recorder**, **Presenter**, **Reflector**).  Prerequisites: the *The Shell: Your Agent's Native Habitat* and *Docker from Zero: Containers for Agent Builders* supplemental activities, completed honestly.  Hardware note: the full stack runs comfortably on a mini PC or a mid-range laptop because we choose small models; nothing here requires a GPU. After class, please respond to the reflective prompt on your own in your notebook.
