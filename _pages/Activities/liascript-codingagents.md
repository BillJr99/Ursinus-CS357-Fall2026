...
- ( ) "Use Black for formatting" — this is a personal style preference that the developer applies to all their projects
...
- ( ) "My preferred model is llama3.2 at temperature 0.2" — this is a personal runtime preference
- ( ) "Open files in VSCode rather than the terminal editor" — this is a personal tooling preference
