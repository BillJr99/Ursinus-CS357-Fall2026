...
- Pope Leo XIV. *Magnifica Humanitas* (Encyclical Letter, 2026). [vatican.va](https://www.vatican.va/content/leo-xiv/en/encyclicals/documents/20260515-magnifica-humanitas.html). A magisterial encyclical on artificial intelligence and the dignity of the human person — a non-secular ethical lens to read alongside the frameworks above; contrast its account of what AI can and cannot be with the utilitarian, deontological, and virtue lenses. (Companion document: the 2025 dicasterial Note *Antiqua et Nova*.)
