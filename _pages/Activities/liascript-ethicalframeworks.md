...
3. The utilitarian analysis depends on predicting aggregate effects of persuasion at scale. This is genuinely hard to do. Does epistemic uncertainty about consequences weaken the utilitarian argument for refusal, or strengthen it?
...
9. Apply the dual newspaper test to the maximum-capability email agent. Write the first sentence of both the harm story and the paternalism story. Does the test give you a clear answer about which design is preferable, or does it surface a genuine tension?
...
- Dicasteries for the Doctrine of the Faith and for Culture and Education. *Antiqua et Nova: Note on the Relationship Between Artificial Intelligence and Human Intelligence* (2025). vatican.va. A faith-tradition perspective on AI and the human person — useful as a non-secular ethical lens alongside the frameworks above; read for its account of what it claims AI can and cannot be, and contrast it with the utilitarian and virtue lenses. <!-- TODO(instructor): confirm this is the intended "Pope's encyclical" reference (Antiqua et Nova is a dicastery Note, not a papal encyclical) and decide required vs. optional. -->
