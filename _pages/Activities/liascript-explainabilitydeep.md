...
- [Credit Score Feature Weight Estimator notebook](/files/notebooks/CreditScoreFeatureWeightEstimator.ipynb) — a runnable companion that trains a fully transparent linear credit-scoring model and reads its feature weights out as an equation, the baseline against which SHAP and LIME explanations are judged.
