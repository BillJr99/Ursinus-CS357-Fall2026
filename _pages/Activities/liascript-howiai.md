...
comment: Render with https://liascript.github.io/course/?https://github.com/BillJr99/Ursinus-CS357/blob/gh-pages/_pages/Activities/liascript-howiai.md or locally via https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-howiai.md
...
4. The vault is a retrieval problem you already know how to think about. Compare answering a question by giving an agent your whole `wiki/` folder against building a RAG index over it, using what you built in the *RAG Knowledge Base* lab. At what vault size does the first stop working, and what exactly breaks?

   > *Hint: The failure has a name from the memory session, and a number attached to it.*
...
1. *Zone audit.*
   ...
   - *You've succeeded when*: You have a tree with three zones, and you can name at least one file whose zone was genuinely ambiguous, plus the rule you used to decide.
