...
**Societal:** Multi-agent debate has been proposed as a safety mechanism for AI systems: have one model check another's outputs, or have multiple models argue before a decision is made. Based on what you learned today about correlated errors, what is the fundamental limitation of using AI models to check other AI models trained on the same data? What would it take to make AI-oversight-of-AI genuinely reliable rather than a false sense of security?

---

→ **Coming Up Next:** The final activities move from individual patterns to system design — how to combine pipelines, debate, and critique-refine into a complete multi-agent application, and how to evaluate the system holistically rather than component by component.
