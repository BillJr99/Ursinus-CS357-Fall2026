...
- [Sentence Prediction with BERT notebook](/files/notebooks/Sentence_Prediction_with_BERT.ipynb) — a runnable companion that uses BERT's masked-token predictions to see contextual embeddings in action.
