...
info:
  ...
  rubric:
  - weight: 25
    description: Analysis of Written Assignment: Exploring Generative AI
    preemerging: Outlines key ideas about Written Assignment: Exploring Generative AI with concise summaries.
    beginning: Explains core ideas about Written Assignment: Exploring Generative AI with relevant detail and early examples.
    progressing: Develops a clear, accurate analysis of Written Assignment: Exploring Generative AI supported by well-chosen examples.
    proficient: Provides a comprehensive, insightful analysis of Written Assignment: Exploring Generative AI that connects ideas to broader implications.
  - weight: 25
