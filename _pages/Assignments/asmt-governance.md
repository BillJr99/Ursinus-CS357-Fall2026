...
title: "Written Assignment: Governance Policy"
...
info:
  ...
  rubric:
    - weight: 25
      ...
      preemerging: Provides minimal or incomplete descriptions of AI governance ideas.
      beginning: Explains core governance principles (e.g., transparency, accountability) with limited examples.
      progressing: Offers clear and accurate analysis, linking governance principles to real-world AI systems.
      proficient: Demonstrates deep understanding of governance frameworks; critically evaluates trade-offs and implications.
    - weight: 25
      description: Application & Policy Design
      preemerging: Draft policy is incomplete, vague, or not contextually grounded.
      beginning: Draft policy addresses some governance areas but lacks specificity or practical mechanisms.
      progressing: Draft policy addresses multiple governance dimensions with clear, feasible guidelines.
      proficient: Draft policy is comprehensive, well-structured, realistic, and demonstrates creativity in addressing challenges.
    - weight: 25
    ...
    - weight: 25
      ...
      beginning: Mostly organized with some clarity or flow issues.
      progressing: Well-organized narrative with clear transitions, proper citations, and minimal errors.
      proficient: Highly polished, professional writing with excellent clarity, flow, and precise citation practices.
...
1. **Choose a Context**  
   Select an organization or domain (e.g., higher education, healthcare, finance, public administration).

2. **Identify Governance Concerns**  
   - What risks arise (bias, privacy, misuse, transparency)?  
   - Who are the stakeholders affected?  

3. **Draft Policy Guidelines**  
