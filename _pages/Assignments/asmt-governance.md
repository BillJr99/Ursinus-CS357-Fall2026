...
info:
  ...
  rubric:
  - weight: 25
    description: Analysis of Written Assignment: Governance Policy
    preemerging: Outlines key ideas about Written Assignment: Governance Policy with concise summaries.
    beginning: Explains core ideas about Written Assignment: Governance Policy with relevant detail and early examples.
    progressing: Develops a clear, accurate analysis of Written Assignment: Governance Policy supported by well-chosen examples.
    proficient: Provides a comprehensive, insightful analysis of Written Assignment: Governance Policy that connects ideas to broader implications.
  - weight: 25
