...
- [MCP: Connecting Agents to Tools and Your Obsidian Vault]({{ site.lia_viewer_url }}{{ site.raw_pages_url }}Activities/liascript-mcp.md): the session that introduces the MCP protocol and the Python SDK
