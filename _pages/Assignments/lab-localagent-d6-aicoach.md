...
> **Grading:** This page is one of the directions for the [Local Agent Lab]({{ site.baseurl }}/Assignments/LocalAgent).  There are no points attached to this page by itself.  The Local Agent Lab rubric on the core lab page covers the core and the direction together.
...
> - **Pace yourself:** this sits on top of the core lab, and more than half of your time belongs in the non-AI core: the app has to work before the model is added, and that ordering is the point of the direction rather than a suggestion.
