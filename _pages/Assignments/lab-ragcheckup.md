...
**Time budget:** two to three hours total, most of it in class. Part 2 is roughly forty-five minutes if Part 1 went well, because the golden set already exists.
...
- [ ] At least one **partial** or **unsupported** verdict, or an explicit note that you looked for one and everything genuinely checked out.
