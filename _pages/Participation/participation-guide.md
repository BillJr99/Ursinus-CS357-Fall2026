...
title: "CS357: Foundations of Artificial Intelligence - Preparing for Each Class and How Participation Works"
...
info:
  ...
  goals:
    ...
    - To prepare technical activities and readings so the session starts from your attempt
    - To understand how class activities and participation are evaluated
    - To know the many valid ways of contributing, including engaging with classmates' work
...
3. **Attempt the reading response or setup beforehand.** Where a session has a [reading response]({{ site.baseurl }}/Participation/ReadingResponses) or a setup step, do it first. You are not expected to have it all working; you are expected to arrive with an attempt, because that is what makes the in-class work land.
...
- **Take your role** — **Manager, Recorder, Presenter, or Reflector** are each real contributions.
...
- [Reading Responses]({{ site.baseurl }}/Participation/ReadingResponses) — the pre-read notes for discussion days and Reading Group sessions.
- [Reflection Notebook]({{ site.baseurl }}/Participation/ReflectionNotebook) — what to keep in your notebook and how it is evaluated.
- [Reading Group Discussion Leader]({{ site.baseurl }}/Assignments/ReadingGroup) — leading a session for extra credit, and what the audience does.
