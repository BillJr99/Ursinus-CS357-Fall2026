...
| **Stakeholder** | A real person or office outside computer science whose problem your project addresses: a campus office, a local organization, or faculty/students in another discipline. | The Stakeholder Brief |
| **Team Charter** | A short, signed team contract stating your team's norms, roles, decision rules, conflict repair process, and accountability procedures. A living document: re-read at every check-in, revised at midterm. | The charter activity in the second week; every check-in; the midpoint revisit |
...
| **SQR Card** | A structured peer-review card: one **S**trength with evidence, one genuine **Q**uestion, one **R**isk with a suggested mitigation. | Three peer review exchanges: the brief drafts, the proposals, and the gallery walk |
| **Sprint** | A short, fixed-length build cycle ending in a runnable increment, an updated evaluation, and a retrospective. | Final project: three sprints between the proposal and Demo Day |
...
| 3 | **Team Charter** | In-class charter activity (building on the Overview assignment's pre-draft), then the signed charter. All members sign. | [Team Charter and Norms activity]({{ site.lia_viewer_url }}{{ site.raw_pages_url }}Activities/liascript-groupcharter.md) |
...
| 6 | **Peer review round 1** | Brief drafts are exchanged across teams in class for SQR review. | [Structured Peer Review activity]({{ site.lia_viewer_url }}{{ site.raw_pages_url }}Activities/liascript-peerreview.md) |
...
| 10 | **Charter revisit** | Midpoint: the team re-reads its charter, discusses what held and what did not, and files a revision. | [Team Charter and Norms activity]({{ site.lia_viewer_url }}{{ site.raw_pages_url }}Activities/liascript-groupcharter.md) |
...
| 15 | **Peer review round 2** | Cross-team SQR critique of the proposals, in class. | [Structured Peer Review activity]({{ site.lia_viewer_url }}{{ site.raw_pages_url }}Activities/liascript-peerreview.md) |
...
|---|---|---|---|
| **Forming** | Survey through the signed charter | Polite, careful, a little vague. Everyone agrees with everyone. | Use the structure: the survey, the charter activity, and the get-to-know protocol exist to accelerate this stage honestly. |
| **Storming** | Stakeholder Brief through the Literature Review | First real disagreements: over the stakeholder choice, over who is doing the work, over standards. This usually surfaces during the Brief and Literature Review. | Do not panic and do not go silent. Run the charter's conflict protocol. Storming is a stage, not a verdict (Tuckman, 1965). |
| **Norming** | Charter revisit through the proposal | The team develops its own shorthand and rhythms. Roles feel natural. | This is exactly why the charter revisit is scheduled where it is: codify what you actually learned to do. |
...
Work through the **[Team Charter and Norms activity]({{ site.lia_viewer_url }}{{ site.raw_pages_url }}Activities/liascript-groupcharter.md)** together when teams are announced; it walks the seven required elements and gives you the language for the harder ones. Revisit it at the midpoint charter check.
...
- Until the midpoint revisit: every meeting has a written agenda posted **before** the meeting and notes posted **after** (the POGIL Recorder owns this). Notes capture decisions, action items with owners and dates, and open questions.
- After the revisit: agendas may be a single line, but decisions and action items are still logged. Sprint retrospectives always get full notes.
...
The structured peer reviews at the brief, proposal, and gallery-walk stages all use the **SQR protocol**: one Strength with evidence, one genuine Question, one Risk with a mitigation. The **[Structured Peer Review activity]({{ site.lia_viewer_url }}{{ site.raw_pages_url }}Activities/liascript-peerreview.md)** carries the protocol card; bring it to each review round.
