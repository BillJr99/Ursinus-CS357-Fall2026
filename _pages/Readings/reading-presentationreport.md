...
info:
  points: 100
  goals:
    - Develop expertise in a selected AI topic by engaging deeply with both foundational and contemporary sources.
    - Practice synthesizing ideas across multiple readings to highlight connections, tensions, and broader implications.
    - Facilitate an informed, critical discussion with peers about the ethical, technical, and societal dimensions of AI.
  rubric:
    - weight: 25
