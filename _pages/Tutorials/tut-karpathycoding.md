...
- This course: [Governing Coding Agents: Charters, Handoffs, and Durable Memory]({{ site.baseurl }}/Tutorials/AgentGovernance), a production case study of these rules governing a multi-month, multi-agent project.
