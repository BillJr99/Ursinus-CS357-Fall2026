...
## Philosophical Positions on Machine Understanding
...
- Language models may fail to track which facts remain unchanged across a sequence of hypothetical actions because this requires reasoning over an open-ended set of implicit world-state assumptions
