...
- week: "0"
  ...
  - rtitle: "Interactive (going deeper): The Token Prediction Playground — an unplugged, in-browser simulator showing what next-token prediction can and cannot do"
    rlink: "https://www.billmongan.com/Ursinus-CS357-Fall2026/TokenPredictor"
  - rtitle: "Going Deeper: AI Capabilities and Limitations (Anthropic Skilljar course) — a short self-paced companion to today's Capabilities and Limitations Framework"
...
- week: "2"
  ...
  - rtitle: "Required prep for Lab 1 (all directions): RESTful LLM Access — The /v1/chat/completions Paradigm, curl, and the OpenAI SDK"
    rlink: "https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-restllmapi.md"
  - rtitle: "Reference: Ollama Structured Outputs — schema-constrained JSON (used in Lab 1's required structured-output segment)"
    rlink: "https://docs.ollama.com/capabilities/structured-outputs"
  - rtitle: "Reference: Instructor — typed structured output with Pydantic and Ollama"
    rlink: "https://python.useinstructor.com/integrations/ollama/"
  - rtitle: "Reference: Outlines — grammar-constrained generation (validity by construction)"
    rlink: "https://github.com/dottxt-ai/outlines"
  - rtitle: "Reference: Hugging Face Agents Course — smolagents (a lightweight tool-calling framework for Lab 1)"
...
- week: "4"
  ...
  - rtitle: "Going Deeper — Theory Deep Dive: Attention and Transformers, Conceptually and by Hand"
  ...
  - rtitle: "AI by Hand, Attention worksheets (going deeper)"
...
- week: "6"
  ...
  - rtitle: "Required prep for Lab 1 Directions 2–3 only: Docker from First Principles"
    rlink: "https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-docker.md"
  - rtitle: "Supplemental Tutorial: Agentic OpenWebUI — Tools, Uploads, and Multi-Agent Workflows (source material for Lab 1's low-code route)"
...
- week: "8"
  ...
  readings:
  - rtitle: "Supplemental Activity: Advanced Agent Loops — Reflection, Recovery, and Control Flow (its two key models are folded into today's orchestration activity; the full version is optional going-deeper)"
...
- week: "9"
  ...
  readings:
  - rtitle: "Supplemental Activity: Stochastic Multi-Agent Consensus (its clustering model is built step-by-step inside Lab 4 Part 2; the full activity is optional going-deeper)"
...
- week: "9"
  ...
  deliverables:
  - dtitle: "Final Project Handed Out (three directions: Custom Agent Team, Responsible AI Audit, or Build and Publish an Open-Source Agent)"
...
- week: "10"
  ...
  - rtitle: "Reference: promptfoo — declarative LLM/agent eval and red-teaming (Lab 5 harness option, runs against Ollama)"
    rlink: "https://www.promptfoo.dev/docs/intro/"
  - rtitle: "Reference: Inspect AI (UK AI Security Institute) — Dataset/Solver/Scorer eval framework (Lab 5 harness option)"
    rlink: "https://inspect.aisi.org.uk/"
  - rtitle: "Reference: Your AI Product Needs Evals (Hamel Husain) — error-analysis-first evaluation methodology"
...
- week: "11"
  ...
  deliverables:
  - dtitle: "Final Project Proposal Due (all directions)"
    dlink: "Projects/FinalProject"
    points: "25"
    rubricpath: "_pages/Projects/proj-finalproject.md"
  readings:
...
- week: "11"
  ...
  - rtitle: "Required prep for Lab 6 Direction 1: Prompt Injection — Attacks and Defenses"
    rlink: "https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-promptinjection.md"
  - rtitle: "Reference: OWASP Top 10 for LLM Applications (2025) — LLM01 Prompt Injection and beyond (Lab 6 shared warm-up and Direction 1)"
    rlink: "https://genai.owasp.org/llm-top-10/"
  - rtitle: "Interactive: Gandalf (Lakera) — prompt-injection game (Lab 6 shared warm-up)"
    rlink: "https://gandalf.lakera.ai/"
  - rtitle: "Interactive: Tensor Trust — attack-and-defend prompt-injection game (Lab 6 shared warm-up)"
...
- week: "12"
  ...
  - rtitle: "Supplemental Activity: What Kind of Model Is This? Base, Instruct, Reasoning, and Vision Models"
...
- week: "15"
  ...
  - rtitle: "Demo Day Guide: who is in the room (community partners, alumni, industry guests, and faculty, as available) and how to talk to them"
    rlink: "https://www.billmongan.com/Ursinus-CS357-Fall2026/Assignments/DemoDayGuide"
  deliverables:
  - dtitle: "Final Project Due and Demo Day Presentations (all directions; multi-audience — technical peers and community stakeholders)"
    dlink: "Projects/FinalProject"
    points: "75"
    rubricpath: "_pages/Projects/proj-finalproject.md"
