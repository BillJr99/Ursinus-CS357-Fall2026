...
info:
  ...
  class_notebook: "https://ursinuscollege365-my.sharepoint.com/personal/wmongan_ursinus_edu/Documents/Class Notebooks/CS357 Fall 2026"
...
grade_breakdown:
- category: "Labs (8 graded items: six full labs, each with a direction you choose, plus two lab checkpoints - the Golden-Set Benchmark inside the Lab 1 window and the RAG Quality Checkup inside the Lab 2 window)"
  weight: "35%"
...
- week: "1"
  ...
  - rtitle: "Optional depth — tutorial: RESTful LLM Access — The /v1/chat/completions Paradigm, curl, and the OpenAI SDK"
...
- week: "2"
  ...
  deliverables:
  - dtitle: "Signed Team Charter (Forming) Due"
  ...
  - rtitle: "Required prep for Lab 1 (all directions): Structured Outputs — JSON Mode, Tool Schemas, and Output Validation"
  ...
  - rtitle: "Required prep for Lab 1 (all directions): RESTful LLM Access — The /v1/chat/completions Paradigm, curl, and the OpenAI SDK"
    rlink: "https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-restllmapi.md"
  - rtitle: "Optional depth — reference: Ollama Structured Outputs — schema-constrained JSON (used in Lab 1's required structured-output segment)"
  ...
  - rtitle: "Optional depth — reference: Hugging Face Agents Course — smolagents (a lightweight tool-calling framework for Lab 1)"
    rlink: "https://huggingface.co/learn/agents-course/en/unit2/smolagents/introduction"
  - rtitle: "Optional depth — tutorial: Building an AI Chess Coach — LLM API Calls in a Real Web App"
...
- week: "2"
  ...
  deliverables:
  - dtitle: "Stakeholder Brief Handed Out"
...
- week: "3"
  ...
  deliverables:
  - dtitle: "Lab 1 Checkpoint: Golden-Set Benchmark Handed Out"
...
- week: "3"
  ...
  readings:
  - rtitle: "Required prep for Lab 1 Direction 4: MCP Deep Dive — REST APIs, OAuth 2.0 Flows, and Secure Tool Invocation"
  ...
  - rtitle: "Hugging Face MCP Course (built with Anthropic) — protocol, building a server, connecting clients (supports Lab 1 MCP work)"
...
- week: "4"
  ...
  deliverables:
  - dtitle: "Lab 1 Checkpoint: Golden-Set Benchmark Due"
    dlink: "Assignments/GoldenSet"
    points: "100"
    rubricpath: "_pages/Assignments/lab-goldenset.md"
  ...
  - rtitle: "Optional depth — AI by Hand, Attention worksheets (going deeper)"
...
- week: "4"
  ...
  - rtitle: "Optional depth — video: RAG Pipeline Deep Dive (YouTube)"
    rlink: "https://www.youtube.com/watch?v=QmUsG_3wHPg"
  - rtitle: "Optional depth — tutorial: A Threaded Auto-Research Pipeline (parallel workers, local summarization, merged digest)"
...
- week: "5"
  ...
  - dtitle: "Intra-Team Check-In 1 (Storming into Norming) Due"
    dlink: "Projects/PBLThread"
    points: "3"
    rubricpath: "_pages/Projects/proj-pblthread.md"
  readings:
  - rtitle: "Mitchell, Chapter 4"
  - rtitle: "Activity (15 minutes, in class): Structured Peer Review — SQR protocol card for the Stakeholder Brief draft exchange (read the full Peer Review activity before class)"
...
- week: "6"
  ...
  deliverables:
  - dtitle: "Lab 2 Checkpoint: RAG Quality Checkup Handed Out"
    dlink: "Assignments/RAGCheckup"
    points: "100"
    rubricpath: "_pages/Assignments/lab-ragcheckup.md"
  - dtitle: "Stakeholder Brief Due"
    dlink: "Assignments/StakeholderBrief"
    points: "100"
    rubricpath: "_pages/Assignments/asmt-stakeholderbrief.md"
  - dtitle: "Literature Review Handed Out"
    dlink: "Assignments/LitReview"
    points: "100"
    rubricpath: "_pages/Assignments/asmt-litreview.md"
  readings:
  - rtitle: "Studio session: bring your Lab 2 pipeline-in-progress and your stuck points — today is open build, debugging, and review time before fall break (the Lab 2 checkpoint lands the Tuesday after break, and Lab 2 itself that Thursday)"
  ...
  - rtitle: "Required prep for Lab 1 Directions 2–3 only: Docker from First Principles"
    rlink: "https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-docker.md"
  - rtitle: "Optional depth — tutorial: Agentic OpenWebUI — Tools, Uploads, and Multi-Agent Workflows (source material for Lab 1's low-code route)"
...
- week: "8"
  date: "0"
  title: "Advanced Agent Loops and Orchestration: Reflection, Pipelines, Routers, and Planners"
  ...
  - rtitle: "Optional depth — activity: Debugging AI Agents — What Went Wrong and How to Find Out"
  ...
  - rtitle: "Optional depth — video: Agentic Workflows — a full free course on orchestration, multi-agent MCP, and agent chatrooms (Nick Saraev)"
    rlink: "https://www.youtube.com/watch?v=MxyRjL7NG18"
  - rtitle: "Optional depth — case study: Governing Coding Agents — Charters, Handoffs, and Durable Memory"
  ...
  deliverables:
  - dtitle: "Lab 2 Checkpoint: RAG Quality Checkup Due"
    dlink: "Assignments/RAGCheckup"
    points: "100"
    rubricpath: "_pages/Assignments/lab-ragcheckup.md"
  - dtitle: "Literature Review: Individual Annotated Bibliographies Due"
    dlink: "Assignments/LitReview"
    points: "3"
    rubricpath: "_pages/Assignments/asmt-litreview.md"
- week: "8"
...
- week: "9"
  ...
  - rtitle: "Reading Response / Discussion: post a short response before class — when does a multi-agent design help, and when does it just cost tokens?"
    rlink: "https://www.billmongan.com/Ursinus-CS357-Fall2026/Participation/ReadingResponses"
  - rtitle: "Optional depth — activity: Stochastic Multi-Agent Consensus (its clustering model is built step-by-step inside Lab 4 Part 2; the full activity is optional going-deeper)"
...
- week: "9"
  ...
  - dtitle: "Literature Review: Team Synthesis Due"
    dlink: "Assignments/LitReview"
    points: "100"
    rubricpath: "_pages/Assignments/asmt-litreview.md"
  readings:
  ...
  - rtitle: "Optional depth — tutorial: Publishing Artifacts (GHCR, Docker Hub, and npm)"
  ...
  - rtitle: "Optional depth — activity: Deploying Agents — From Laptop to Production"
  ...
  - rtitle: "Optional depth — tutorial: Scheduled and Autonomous Agent Runs — Cron, systemd, n8n, and GitHub Actions (clone → review → open a PR)"
...
- week: "10"
  ...
  deliverables:
  - dtitle: "Intra-Team Check-In 2 (Norming into Performing) Due"
    dlink: "Projects/PBLThread"
    points: "3"
    rubricpath: "_pages/Projects/proj-pblthread.md"
  - dtitle: "Written Assignment 2: Design Your Agent System Due"
    dlink: "Assignments/AgentSystemDesign"
    points: "100"
    rubricpath: "_pages/Assignments/asmt-agentsystemdesign.md"
  readings:
  ...
  - rtitle: "Optional depth — tutorial: Multimodal Agents — Vision, Documents, and Code as First-Class Inputs"
  ...
  - rtitle: "Optional depth — video: n8n for Everyone — visual AI agents and workflows (Nick Saraev)"
...
- week: "10"
  ...
  readings:
  - rtitle: "Required prep for Lab 5: Testing Agents — Evaluation, Regression, and the Non-Determinism Problem"
  ...
  - rtitle: "Optional depth — reference: promptfoo — declarative LLM/agent eval and red-teaming (Lab 5 harness option, runs against Ollama)"
    rlink: "https://www.promptfoo.dev/docs/intro/"
  - rtitle: "Optional depth — reference: Inspect AI (UK AI Security Institute) — Dataset/Solver/Scorer eval framework (Lab 5 harness option)"
  ...
  - rtitle: "Optional depth — activity: Agent Observability and Distributed Tracing"
  ...
  - rtitle: "Optional depth — activity: Benchmark Design — How We Know If AI Systems Work"
  ...
  - rtitle: "Optional depth — activity: The Economics of AI Agents — Pricing, Incentives, and Market Dynamics"
  ...
  - rtitle: "Optional depth — activity: LLM Serving in Production — TTFT, KV Cache, Batching, and Cost Modeling"
  ...
  - rtitle: "Optional depth — activity: Integrating AI with Institutional Systems — LMS, Assessment Software, and Student Information Systems"
  ...
  - dtitle: "Written Assignment 3: Responsible AI in Practice Handed Out"
    dlink: "Assignments/ResponsibleAIPractice"
    points: "100"
    rubricpath: "_pages/Assignments/asmt-responsibleaipractice.md"
- week: "11"
  date: "0"
  ...
  - rtitle: "Optional depth — activity: AI Coding Agent Security — Poisoned Repos, the Software Supply Chain, and State-of-the-Art Defenses (indirect injection via repo artifacts, slopsquatting/dependency confusion, spotlighting/CaMeL/instruction-hierarchy, and the lethal trifecta)"
  ...
  - rtitle: "Optional depth — activity: Red-Teaming and Adversarial Robustness — Prompt Injection, Jailbreaks, and PAIR"
  ...
  - rtitle: "Optional depth — activity: Using AI for Academic Research — Literature Search, Citation Checking, and Structured Workflows"
...
- week: "11"
  ...
  - rtitle: "Reading Response / Discussion: post a short response before class — one design choice you would make differently in a system you deploy"
    rlink: "https://www.billmongan.com/Ursinus-CS357-Fall2026/Participation/ReadingResponses"
  - rtitle: "Required prep for Lab 6 Direction 1: Prompt Injection — Attacks and Defenses"
    rlink: "https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-promptinjection.md"
  ...
  - rtitle: "Optional depth — interactive: Gandalf (Lakera) — prompt-injection game (Lab 6 shared warm-up)"
    rlink: "https://gandalf.lakera.ai/"
  - rtitle: "Optional depth — interactive: Tensor Trust — attack-and-defend prompt-injection game (Lab 6 shared warm-up)"
  ...
  - rtitle: "Optional depth — reference: OWASP Top 10 for LLM Applications (2025) — LLM01 Prompt Injection and beyond (Lab 6 shared warm-up and Direction 1)"
    rlink: "https://genai.owasp.org/llm-top-10/"
  - rtitle: "Optional depth — case study: Early-Alert and At-Risk Identification with Local AI (synthetic data)"
  ...
  - rtitle: "Optional depth — activity: The Philosophy and Psychology of Artificial Intelligence"
  ...
  - rtitle: "Optional depth — activity: Ethical Frameworks for Agentic AI Systems"
  ...
  - rtitle: "Optional depth — activity: Dataset Documentation — Model Cards and Datasheets"
  ...
  - rtitle: "Optional depth — activity: AI in Education — Opportunity, Disruption, and the Integrity Question"
  ...
  - rtitle: "Optional depth — activity: AI and the Future of Work — Automation, Displacement, and Adaptation"
  ...
  - rtitle: "Optional depth — activity: AI for Scientific Discovery — AlphaFold, Drug Discovery, and Reproducibility"
...
- week: "12"
  date: "1"
  title: "Governance, Policy Writing, and the Environmental Cost of Intelligence"
  ...
  deliverables:
  - dtitle: "Written Assignment 3: Responsible AI in Practice Due"
    dlink: "Assignments/ResponsibleAIPractice"
    points: "100"
    rubricpath: "_pages/Assignments/asmt-responsibleaipractice.md"
  readings:
  ...
  - rtitle: "Activity: AI Policy Writing Workshop (see the Governance and Policy direction of Written Assignment 3)"
  ...
  - rtitle: "Optional depth — activity: Reinforcement Learning and RLHF — How Human Feedback Shapes AI Behavior"
  ...
  - rtitle: "Optional depth — activity: What Kind of Model Is This? Base, Instruct, Reasoning, and Vision Models"
    rlink: "https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-modeltypes.md"
  - rtitle: "Optional depth — activity: AI Regulation — EU AI Act, NIST AI RMF, and Sector Rules"
...
- week: "13"
  ...
  - rtitle: "Optional depth — tutorial: The AI Maker Module (Testing, CI, and Human-Centric Design)"
  ...
  - rtitle: "Optional depth — activity: Explainability in Depth — SHAP, LIME, Attention, and the Limits of Interpretation"
...
- week: "14"
  ...
  readings:
  - rtitle: "Project Thread: community-partner feedback pass — share your gallery-walk artifact with your community stakeholder this week and log their feedback for Demo Day"
    rlink: "https://www.billmongan.com/Ursinus-CS357-Fall2026/Projects/FinalProject"
...
- week: "14"
  ...
  link: "https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS357/gh-pages/_pages/Activities/liascript-projectstudio.md"
  deliverables:
  - dtitle: "Intra-Team Check-In 3 (Performing into Adjourning) Due"
    dlink: "Projects/PBLThread"
    points: "3"
    rubricpath: "_pages/Projects/proj-pblthread.md"
  - dtitle: "Lab 6: Responsible AI Due"
    dlink: "Assignments/ResponsibleAI"
    points: "100"
    rubricpath: "_pages/Assignments/lab-responsibleai.md"
- week: "15"
  ...
  - dtitle: "Final Project and Demo Day Presentations Due"
    ...
    points: "75"
    rubricpath: "_pages/Projects/proj-finalproject.md"
  - dtitle: "Reading Group Due"
    dlink: "Assignments/ReadingGroup"
    points: "10"
    rubricpath: "_pages/Assignments/asmt-readinggroup.md"
  - dtitle: "Reading Responses Due"
    dlink: "Participation/ReadingResponses"
    points: "10"
    rubricpath: "_pages/Participation/reading-responses.md"
...
- **Every lab is within reach.** Every lab has a programming pathway that asks for only intro-level Python, with starter code provided — you extend a working scaffold, never start from a blank page. **Labs 1, 2, 5, and 6 additionally offer a supported low-code pathway** — OpenWebUI, Langflow, declarative promptfoo configuration, and an attack-and-policy track, respectively — graded on the same rubric as the programming pathway. **Labs 3 and 4 are code-based**, with heavily scaffolded starter code that keeps the programming at that same intro level.
