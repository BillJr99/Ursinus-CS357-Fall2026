...
<what was finished, with the commands or commits that prove it>
...
<tests run and their results, logs collected, checks performed>

### Next Safe Action

<the one action a brand-new agent could take next without breaking anything>
